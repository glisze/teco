#!/usr/bin/env expect
  ...
  puts "# [set about {teco basic initialisation}]"
...
if {[catch "spawn tecoc"]==0} {
  ...
  set about {inserting a return into the empty gives either 1 or 2 for z}
